import { Box, Paper, Image, Text, Button } from "@mantine/core";
import { Link } from "react-router-dom";
import img404 from "..//..//img/Image404.jpg";

import style from "..//Movies/Movies.module.scss";

const Page404 = ({ setActiveTab }) => {
    console.log("render 404");
    return (
        <Box className={style.page404}>
            <Paper className={style.page404_logo}>
                <Link
                    to={"/arrowflicks"}
                ...
                >
                    <svg
                        ...
                        className={style.page404_svg}
                        viewBox="0 0 179 36"
                        fill="none"
                    >
                        <g filter="url(#filter0_b_25001_507)">
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M26.6066 6.51472L17.0606 16.0607C16.4748 16.6464 15.5251 16.6464 14.9393 16.0607L5.39335 6.51472C4.80757 5.92893 4.80757 4.97918 5.39335 4.3934C5.97914 3.80761 6.92889 3.80761 7.51467 4.3934L14.5 11.3787L14.5 4C14.5 3.17157 15.1715 2.5 16 2.5C16.8284 2.5 17.5 3.17157 17.5 4L17.5 11.3787L24.4852 4.3934C25.071 3.80761 26.0208 3.80761 26.6066 4.3934C27.1923 4.97918 27.1923 5.92893 26.6066 6.51472Z"
                                fill="#9854F6"
                            />
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M5.39344 29.4853L14.9394 19.9393C15.5252 19.3536 16.4749 19.3536 17.0607 19.9393L26.6066 29.4853C27.1924 30.0711 27.1924 31.0208 26.6066 31.6066C26.0209 32.1924 25.0711 32.1924 24.4853 31.6066L17.5 24.6213L17.5 32C17.5 32.8284 16.8285 33.5 16 33.5C15.1716 33.5 14.5 32.8284 14.5 32L14.5 24.6213L7.51476 31.6066C6.92898 32.1924 5.97923 32.1924 5.39344 31.6066C4.80765 31.0208 4.80765 30.0711 5.39344 29.4853Z"
                                fill="#9854F6"
                            />
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M27.4853 28.6066L17.9393 19.0606C17.3536 18.4748 17.3536 17.5251 17.9393 16.9393L27.4853 7.39335C28.0711 6.80757 29.0208 6.80757 29.6066 7.39335C30.1924 7.97914 30.1924 8.92889 29.6066 9.51467L22.6213 16.5L30 16.5C30.8284 16.5 31.5 17.1715 31.5 18C31.5 18.8284 30.8284 19.5 30 19.5L22.6213 19.5L29.6066 26.4852C30.1924 27.071 30.1924 28.0208 29.6066 28.6066C29.0208 29.1923 28.0711 29.1923 27.4853 28.6066Z"
                                fill="#9854F6"
                            />
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M4.51472 7.39344L14.0607 16.9394C14.6464 17.5252 14.6464 18.4749 14.0607 19.0607L4.51472 28.6066C3.92893 29.1924 2.97918 29.1924 2.3934 28.6066C1.80761 28.0209 1.80761 27.0711 2.3934 26.4853L9.37868 19.5L2 19.5C1.17157 19.5 0.499999 18.8285 0.499999 18C0.499999 17.1716 1.17157 16.5 2 16.5L9.37868 16.5L2.3934 9.51476C1.80761 8.92898 1.80761 7.97923 2.3934 7.39344C2.97918 6.80765 3.92893 6.80766 4.51472 7.39344Z"
                                fill="#9854F6"
                            />
                            <path
                        ...
                        <defs>
                            ...
                            >
                                ...
                                <feComposite
                                    in2="SourceAlpha"
                                    operator="in"
                                    result="effect1_backgroundBlur_25001_507"
                                />
                                <feBlend
                                    mode="normal"
                                    in="SourceGraphic"
                                    in2="effect1_backgroundBlur_25001_507"
                                    result="shape"
                                />
                            </filter>
                        </defs>
            ...
            <Image src={img404} className={style.page404_img} />
            <Text className={style.page404_text}>
            ...
            >
                <Button className={style.page404_button}>Go Home</Button>
            </Link>
        </Box>
    );
};
