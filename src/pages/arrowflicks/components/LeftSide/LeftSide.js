...
const LeftSide = ({ activeTab, setActiveTab, style, showMenu, toggle }) => {
    const navigate = useNavigate();

    return (
        <Box
            className={style.left_side_wrap}
            style={
                window.innerWidth > 993
                    ? { display: "block" }
                    : showMenu === false && window.innerWidth <= 993
                    ? { display: "none" }
                    : {
                          display: "block",
                          position: "absolute",
        ...
        >
            <Paper className={style.logo}>
                <Link
                    to={"/arrowflicks"}
                    onClick={() => {
                        setActiveTab("/arrowflicks");
            ...
            >
                <Tabs.List>
                    <Tabs.Tab
                        value="/arrowflicks"
                        className={
                            activeTab === "/arrowflicks"
                                ? style.left_side_tab_active
                                : style.left_side_tab
                        }
                    >
                        Movies
                    ...
                    <Tabs.Tab
                        value="/arrowflicks/ratedmovies"
                        className={
                            activeTab === "/arrowflicks/ratedmovies"
                                ? style.left_side_tab_active
                                : style.left_side_tab
                        }
                    >
