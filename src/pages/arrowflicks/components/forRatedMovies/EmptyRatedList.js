...
const EmptyRatedList = ({ setActiveTab }) => {
    return (
        <Flex
            w={"100%"}
            justify={"center"}
        ...
        >
            ...
            >
                ...
                >
                    <path
                        d="M232.034 64.487C296.408 97.497 314.791 75.802 343.744 119.783C372.697 163.765 352.969 245.958 292.133 259.434C231.296 272.91 220.389 239.729 137.825 254.123C55.2619 268.517 13.3819 142.924 75.1179 90.553C136.855 38.183 167.661 31.477 232.034 64.487Z"
                        fill="white"
                    />
                </mask>
                <g mask="url(#mask0_18006_4892)">
                    <path
                        d="M232.034 64.487C296.408 97.497 314.791 75.802 343.744 119.783C372.697 163.765 352.969 245.958 292.133 259.434C231.296 272.91 220.389 239.729 137.825 254.123C55.2619 268.517 13.3819 142.924 75.1179 90.553C136.855 38.183 167.661 31.477 232.034 64.487Z"
                        fill="#F2EBF9"
                    />
                    ...
                    />
                    <path
                        d="M190.806 -0.679932C201.231 71.2191 177.817 108.365 120.566 110.76C34.689 114.352 96.733 49.1351 126.03 75.1331C155.327 101.13 152.942 157.423 107.23 196.005C76.755 221.727 42.033 234.588 3.06396 234.588M367.769 196.825C240.858 188.625 140.19 233.817 65.765 332.401"
                        stroke="white"
                        stroke-width="1.32"
                    />
                    <path
                        d="M34.6899 195.88C117.937 218.195 171.606 263.702 195.696 332.401"
                        stroke="white"
                        stroke-width="1.32"
                    />
                    <path
                    ...
                    />
                    <path
                        d="M367.769 153.387C314.599 205.224 291.782 268.07 299.32 341.925"
                        stroke="white"
                        stroke-width="1.32"
                    />
                    <path
                        d="M34.6899 126.345C166.014 152.879 269.066 224.739 343.844 341.925"
                        stroke="white"
                        stroke-width="1.32"
                    />
                    <path
                        d="M82.9299 -0.679932C42.7899 7.53407 27.9499 24.6621 38.4079 50.7051C54.0949 89.7691 111.904 163.64 34.6899 176.452M34.6899 264.141C65.9459 310.73 99.0669 322.378 134.051 299.083C186.528 264.141 204.321 256.887 226.192 264.141C240.773 268.976 254.033 291.73 265.97 332.401"
                        stroke="white"
                        stroke-width="1.32"
                    />
                    <path
                        d="M358.792 205.358H45.072V267.838H358.792V205.358Z"
                        fill="#F2EBF9"
                    />
                    <path
                        d="M17.792 205.021H400.592"
                        stroke="black"
                        stroke-width="1.294"
                ...
                >
                    <path
                        d="M96.2 110.384L113.921 102.497L128.659 135.591L110.939 143.478L96.2 110.384Z"
                        fill="white"
                    />
                </mask>
                <g mask="url(#mask1_18006_4892)">
                    <path
                ...
                <path
                    d="M216.98 175.79L217.422 200.795L260.41 200.053L259.969 175.048L216.98 175.79Z"
                    fill="white"
                />
                <path
                    fill-rule="evenodd"
                ...
                />
                <path
                    d="M180.306 165.053L158.03 166.01L143.883 145.244"
                    stroke="black"
                    stroke-width="1.32"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                ...
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M223.527 170.865L224.97 206.846L222.976 206.88L222.342 170.885L223.527 170.865ZM89.904 72.7041C98.992 68.6591 109.642 72.7501 113.692 81.8421C113.79 82.0621 113.884 82.2861 113.973 82.5101L115.914 87.3881C119.616 96.6881 115.319 107.25 106.178 111.319C97.142 115.341 86.553 111.273 82.528 102.233L80.405 97.4681C76.19 88.0021 80.442 76.9151 89.904 72.7041Z"
                    fill="black"
                />
                <path
                    fill-rule="evenodd"
                ...
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M82.4169 77.3089C80.0009 77.0539 74.1499 78.4309 74.3369 87.0089C74.4349 91.5379 77.6869 102.456 87.6169 108.817C87.9959 109.059 85.3649 101.54 85.5319 100.904C86.7939 96.0849 87.0739 91.1809 86.3729 86.1929C85.1829 77.7229 84.8329 77.5629 82.4169 77.3089Z"
                    fill="black"
                />
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M91.7401 98.4519L89.9801 98.9319C89.4294 99.0822 88.9206 99.3569 88.4928 99.7349C88.065 100.113 87.7297 100.584 87.5126 101.112C87.2956 101.64 87.2026 102.21 87.2408 102.78C87.279 103.35 87.4474 103.903 87.7331 104.397C88.4463 105.632 89.5157 106.623 90.8015 107.24C92.0872 107.857 93.5294 108.072 94.9391 107.856L95.8661 107.714"
                    fill="white"
                />
                <path
                ...
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M118.246 89.814L123.146 94.24L120.465 97.11"
                    fill="white"
                />
                <path
                    d="M118.246 89.814L123.146 94.24L120.465 97.11"
                ...
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M88.178 76.7039C98.03 69.2139 106.543 66.0009 113.718 67.0639C124.479 68.6579 123.598 86.6289 102.979 90.0609C89.233 92.3489 84.299 87.8969 88.178 76.7039Z"
                    fill="black"
                />
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M80.7309 82.46C79.9219 77.703 91.2819 62.604 100.294 62.567C106.302 62.542 107.258 68.16 103.162 79.421C88.7469 84.617 81.2709 85.63 80.7319 82.459L80.7309 82.46ZM58.5519 83.271L60.9419 82.257C65.8739 80.163 71.5699 82.464 73.6639 87.397L123.403 204.575L99.7249 205.098L53.4129 95.993C51.3189 91.06 53.6199 85.365 58.5529 83.271H58.5519Z"
                    fill="black"
                />
                <path
            ...
            <Text ff={"monospace"} fw={600} fz={"20px"}>
                You haven't rated any films yet
            </Text>

            <Link to={"/arrowflicks"} style={{ textDecoration: "none" }}>
                <Button
                    w={"122px"}
                    p={0}
                    h={"40px"}
