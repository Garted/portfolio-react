    ...
    return (
        <section className="services" id="services">
            <div className="container-cr">
                <h2 className="main-title services__title">Our services</h2>
                <p className="main-subtitle services__subtitle">
                    Createx Construction Bureau is a construction giant with a
                ...
                <div className="services__wrap">
                    <div className="services__item">
                        <svg
                            ...
                            fill="none"
                        >
                            <g clipPath="url(#clip0_90023_2081)">
                                <path
                        ...
                        <h4 className="name-title services__item-title">
                            Construction
                        </h4>
                    </div>
                    ...
                    <div className="services__item">
                        <svg
                            ...
                            fill="none"
                        >
                            <g clipPath="url(#clip0_90023_1789)">
                                <path
                    ...
                    <div className="services__item">
                        <svg
                            ...
                            fill="none"
                        >
                            <g clipPath="url(#clip0_90023_1698)">
                                <path
                ...
                <div className="services__block">
                    <h3 className="title-left services__text">
                        Learn more about our services
                    </h3>
                    <button className="main__btn services__btn">
                        View services
                    </button>
                </div>
            </div>
