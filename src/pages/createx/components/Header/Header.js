...
const Header = () => {
    const [showHiddenElements, setShowHiddenElements] = useState({
        showMenu: false,
        showSideMenu: false,
    });
    const socialBlock = (
                ...
                >
                    ...
                    >
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M14.1663 4.86947C12.7856 4.86947 11.6663 5.98875 11.6663 7.36947V32.6299C11.6663 34.0106 12.7856 35.1299 14.1663 35.1299H25.833C27.2137 35.1299 28.333 34.0106 28.333 32.6299V7.36947C28.333 5.98875 27.2137 4.86947 25.833 4.86947H25.694L25.2881 5.84355C25.0293 6.46458 24.4225 6.86909 23.7497 6.86909H16.2497C15.5769 6.86909 14.9701 6.46458 14.7113 5.84355L14.3053 4.86947H14.1663ZM8.33301 7.36947C8.33301 4.1478 10.9447 1.53613 14.1663 1.53613H25.833C29.0547 1.53613 31.6663 4.1478 31.6663 7.36947V32.6299C31.6663 35.8515 29.0547 38.4632 25.833 38.4632H14.1663C10.9447 38.4632 8.33301 35.8515 8.33301 32.6299V7.36947Z"
                            fill="#FF5A30"
                        />
                    </svg>
                </Link>
                <div className="header__call-block">
                    <div className="header__call-text">Call us</div>

                    <Link className="header__call-phone-number" to="/createx">
                        (405) 555-0128
                    </Link>
                </div>
            </div>
            <div className="header__talk">
                <Link
                    onClick={() => checkWidth()}
                    className="header__talk-img"
                    to="/createx"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="header__talk-block">
                    <div className="header__talk-text">Talk to us</div>
                    <Link className="header__talk-email" to="/createx">
                        hello@createx.com
                    </Link>
                </div>
            </div>
    ...
    const checkWidth = () => {
        if (window.innerWidth <= 1229 && window.innerWidth >= 769) {
    ...
    const HeaderLinks = () => {
        const linksWrap = [
            { link: "About Us", id: "/createx/#about" },
            { link: "Services", id: "/createx/#services" },
            { link: "Works", id: "/createx/#works" },
            { link: "News", id: "/createx/#news" },
            { link: "Contacts", id: "/createx/#contacts" },
        ];
        return (
            <ul className="header__links">
                {linksWrap.map((item, index) => (
                    <li
                        onClick={() => {
                            setShowHiddenElements((showHiddenElements) => ({
                                ...showHiddenElements,
        ...
        <>
            <header className="header" id="header">
                <div className="container-cr">
                    <nav className="createx-nav">
                        <div className="header__logo">
                            <Link to="/createx/#header">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="130"
                                    height="22"
                                    ...
                                    fill="none"
                                >
                                    <g clipPath="url(#clip0_90023_2121)">
                                        <path
            ...
            <div
                className={
                    showHiddenElements.showMenu
                        ? "chose-menu chose-menu-show"
                        : "chose-menu"
                }
            >
                {socialBlock}
            ...
            <div
                className={
                    showHiddenElements.showSideMenu
